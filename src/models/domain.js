...
export const Progress = create('Progress', 'progress', { user_id: { type: Number, required: true }, learning_progress: { type: Number, default: 0 }, quiz_scores: mongoose.Schema.Types.Mixed, simulation_scores: mongoose.Schema.Types.Mixed, achievements: [mongoose.Schema.Types.Mixed], weak_topics: [mongoose.Schema.Types.Mixed], total_study_minutes: { type: Number, default: 0 } }, [[{ user_id: 1 }, { unique: true }]]);
